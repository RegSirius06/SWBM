    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.FloatField(default=0, verbose_name='Цена')),
                ('sign', models.CharField(choices=[('dining_services+', 'Дежурный в столовой'), ('activity+', 'Активность'), ('salary+', 'Зарплата'), ('fee+', 'Гонорар'), ('purchase-', 'Покупка'), ('fine-', 'Штраф')], default='fine-', max_length=20, verbose_name='Тип транзакции:')),
            ],
            options={
